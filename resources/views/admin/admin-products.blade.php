...
@section('home-content')
    ...
    <div class="row mb-4">
        ...
        <div class="col-md-6">
            <a href="" class="btn btn-primary mb-2" data-bs-toggle="modal" data-bs-target="#addProductModal">Tambah Produk</a>
        </div>
    </div>
    ...
    <table class="table table-bordered">
            ...
            @foreach ($products as $product)
                ...
                <tr>
                    ...
                    <td>
                        <a href=""  class="btn btn-warning"  data-bs-toggle="modal" data-bs-target="#editProductModal">Edit</a>
                ...
                <div class="modal fade" id="deleteModal{{ $product->id }}"  tabindex="-1" aria-labelledby="deleteProductModalLabel" aria-hidden="true">
                    <div class="modal-dialog">
                        <div class="modal-content">
                            <div class="modal-header">
