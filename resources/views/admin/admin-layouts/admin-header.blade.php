...
<html lang="en">
  ...
  <body >
      ...
      <header class="navbar navbar-expand-md d-print-none" >
        <div class="container-xl">
          ...
          <h1 class="navbar-brand navbar-brand-autodark d-none-navbar-horizontal pe-0 pe-md-3">
            <a href=".">
              <img src="{{ asset('assets/img/logo-transp.png')}}" width="150px" alt="">
            </a>
          </h1>
    ...
    <!-- Libs JS -->
    <script src="{{ asset('assets/libs/apexcharts/assets/apexcharts.min.js?1692870487') }}" defer></script>
    <script src="{{ asset('assets/libs/jsvectormap/assets/js/jsvectormap.min.js?1692870487') }}" defer></script>
    <script src="{{ asset('assets/libs/jsvectormap/assets/maps/world.js?1692870487') }}" defer></script>
    <script src="{{ asset('assets/libs/jsvectormap/assets/maps/world-merc.js?1692870487') }}" defer></script>
    <!-- Tabler Core -->
